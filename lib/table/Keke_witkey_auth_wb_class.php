<?php
class Keke_witkey_auth_wb_class{
	public $_db;
	public $_tablename;
	public $_dbop;
	...
	public $_replace=0;
	public $_where;
	function  keke_witkey_auth_wb_class(){		$this->_db = new db_factory ( );		$this->_dbop = $this->_db->create(DBTYPE);		$this->_tablename = TABLEPRE."witkey_auth_wb";	}
