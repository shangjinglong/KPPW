...
define( "IN_KEKE" ,true);
	...
	db_factory::execute("replace into ".TABLEPRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('11','goods','100','50',0,'1')");
					
	db_factory::execute("replace into ".TABLEPRE."witkey_mark_config (`mark_config_id`,`obj`,`good`,`normal`,`bad`,`type`) values ('12','goods','100','50',0,'2')");
					}
	...
	db_factory::execute("replace into ".TABLEPRE."witkey_model (`model_id`,`model_code`,`model_name`,`model_dir`,`model_type`,`model_dev`,`model_status`,`model_desc`,`on_time`,`hide_mode`,`listorder`,`model_intro`,`indus_bid`,`config`) values ('6','goods','威客作品','goods','shop','kekezu','1','<strong>威客作品的一般流程是：</strong><br /><p>1、买家在网站平台上上传作品，等待后台审核</p><p>2、审核通过后，该作品就会上架，在网站商城里显示</p><p>3、卖家购买作品后，付款</p><p>4、付款后，等待买家提供服务</p><p>5、卖家确认服务后，买家即可得到相应的服务金额</p><p>如果交易过程中不满意，可以申请仲裁<br /></p><br />','1324861116',0,'6','威客作品是网络商城的一种交易模式。','','a:4:{s:10:\"audit_cash\";s:2:\"20\";s:8:\"min_cash\";s:2:\"20\";s:14:\"service_profit\";s:2:\"10\";s:13:\"max_filecount\";s:1:\"1\";}')");
					}
